...
|Semrush|Impact Marketplace規約同意済み。税務情報、profile、media property待ち・申請未送信|回答あり|0|税務情報をHumanが画面入力し、profileとmedia propertyをSaaS TCO Labだけで完了する|
...
2026-07-26に契約同意、Impact credential受付、SMS端末認証、既存Impact accountへのloginまで完了しました。同日、Humanのaction-time承認`impact_terms_accept: GO`後にPartner User AgreementとMaster Program Agreementへ同意しました。現在は税務情報の本人判断で停止し、profile、media property、Semrush申請は未完了です。申請中も承認済みと数えず、Affiliate、data rights、対象site、
