...
const remainingHumanWork = [
  ...
  },
  {
    ...
    why: "価格確認checklistの公式URLをHumanが開き、必要箇所を貼り付けて候補抽出できます。P09/P11は自データcardで直接観測を候補化できます。候補はHuman確認前にcontractへ入りません。",
    steps: ["記事とvendorを選ぶ。P09/P11は自データcardへ実測値を入力する", "料金表または自データを候補へ反映する", "出典・観測日・次回確認日と前回差分を確認する", "Human確認後のJSONを保存し、article_input: done <P-ID>を返す"],
