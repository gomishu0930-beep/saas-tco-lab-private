...
export const pilotPages: readonly PilotPage[] = [
  ...
  { id: "P02", slug: "plan-comparison", title: "プラン比較", intent: "compare", pageType: "comparison", question: "同じ利用条件で複数プランをどう比較するか", readerOutcome: "同一scenarioで価格差と上限差を比較できる", numericFields: [
    { key: "plan.price", label: "各plan料金", valueKind: "price" }, { key: "plan.minimum_seats", label: "最低seat数", valueKind: "seat_count" }, { key: "plan.usage_quota", label: "利用上限", valueKind: "quota" }, { key: "plan.overage_price", label: "超過単価", valueKind: "price" }, { key: "plan.commitment_months", label: "契約月数", valueKind: "duration" },
  ] },
  { id: "P03", slug: "alternatives", title: "代替候補", intent: "replace", pageType: "alternatives", question: "置き換え候補をTCOと適合条件でどう絞るか", readerOutcome: "必要条件を落とさず候補を3社以内へ絞れる", numericFields: [
    { key: "alternative.price", label: "各候補の料金", valueKind: "price" }, { key: "alternative.usage_quota", label: "利用上限", valueKind: "quota" }, { key: "alternative.required_addon_price", label: "必須addon料金", valueKind: "price" }, { key: "alternative.migration_cost", label: "移行費用", valueKind: "price" },
  ] },
